    ...
    const handleClickOpen = () => {
      ...
      const paths={
        ...
        user:[
          ...
          {path:"/user/elections",title:"Elections",icon:<RiUserVoiceFill  fontSize={30} className="icon"/>,id:2},
          {path:"/user/results",title:"Result",icon:<RiUserVoiceFill  fontSize={30} className="icon"/>,id:3},
